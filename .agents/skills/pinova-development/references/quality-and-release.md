...
- `v1.2.6-rc2` / `714122f`: official native-immutable staging/canary pre-release. PR #10 removed the optional Administration-secret and Ruleset prerequisites while retaining post-publication verification. Its Quality and publisher workflows passed, the Release API reports `immutable: true`, Release and both asset attestations passed, and an independent fresh download verified the ZIP SHA-256 `dc6a918c6c9df67010038004ac1b5ce8b16b091fda4d3f7135ec81bb7d4fbfc9`, archive integrity, version, and top-level `pinova/`. It is the installation handoff but remains a pre-release and has not been installed on a site by this workflow.
