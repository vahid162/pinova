...
2. Retain RC1–RC4 unchanged as publication history. Use only the installable `pinova-1.2.6.zip` asset from immutable `v1.2.6-rc5` for the OTP account-interface staging or controlled canary; never substitute GitHub's automatic source archives.
