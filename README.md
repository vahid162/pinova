...
4. در یک نشست جدا تأیید کنید مسیر خصوصی کار می‌کند و درخواست مستقیم `wp-login.php` پاسخ 404 می‌گیرد.

برای بازیابی اضطراری می‌توان موقتاً `PINOVA_BLOCK_NATIVE_LOGIN` را در `wp-config.php` برابر `false` قرار داد یا گزینه را با WP-CLI غیرفعال کرد. مسیر خصوصی جای رمز قوی یا 2FA نیست و نباید در صفحهٔ عمومی سایت منتشر شود.
