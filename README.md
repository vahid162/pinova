...
> **مرحلهٔ فعال پس از ادغام PR27:** PR27 و مستندات آن در `04535ac308e85497f453305c2133facf244d4a54` ادغام شدند؛ بندهای بالاتر، snapshot پیش از این ادغام هستند. اجرای جداگانهٔ `main` به شمارهٔ `35426974523` یک ایراد واقعی بازگشت فوکوس را پیدا کرد و انتشار متوقف شد. اصلاح محدود در [PR28](https://github.com/vahid162/pinova/pull/28) انجام می‌شود. مرحلهٔ بعد، موفقیت CI و بازبینی سرشاخهٔ همان PR، سپس CI کامیت ادغام‌شده و کنترل‌های انتشار نامزد بعدی است؛ ادغام مستندات PR27 نباید دوباره انجام شود. RC9 در این checkpoint آخرین نسخهٔ منتشرشده است و تغییر نکرده است. [گزارش ایراد و اصلاح فوکوس](.agents/reviews/modal-focus-lifecycle.md) را بخوانید و پیش از انتشار وضعیت زندهٔ GitHub را بررسی کنید. این بند ادغام یا انتشار موفق PR28 و نصب روی سایت را اعلام نمی‌کند.
