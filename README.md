...
- صفحهٔ ورود مستقل، واکنش‌گرا و RTL در یک کارت سادهٔ مرکزی با پالت نارنجی/کرم برند، فرم‌های معنایی، کنترل کامل صفحه‌کلید، مسیر امن بدون جاوااسکریپت و نمایش مستقیم پیام Blocked List
